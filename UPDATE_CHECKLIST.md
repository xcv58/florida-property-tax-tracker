...
7. Confirm dead proposals are not shown as active.
8. Confirm county estimates identify source type and proposal version.
9. Confirm the homepage remains high-level and deeper details remain on `/details/`, `/timeline/`, `/counties/`, or `/sources/`.
